    ...
    <section className="grain relative z-[1] flex min-h-screen flex-col justify-center overflow-hidden bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 px-6 pb-16 pt-32 md:px-12 md:pb-16">
      ...
      <div className="relative z-[2]">
        <div className="-translate-y-8 md:-translate-y-14">
          ...
          >
            <span
              className="block text-[clamp(2.8rem,14vw,12rem)] font-extrabold tracking-normal md:tracking-tight text-transparent"
              style={{ WebkitTextStroke: "1.5px #edeced" }}
            >
              {t("line1")}
            </span>
            <span className="block text-[clamp(2.8rem,14vw,12rem)] font-extrabold tracking-normal md:tracking-tight text-orange-500">
              {t("line2")}
            </span>
            <span className="block text-[clamp(2.8rem,14vw,12rem)] font-light italic tracking-normal md:tracking-tight text-gray-100/40">
              {t("line3")}
            </span>
          </motion.h1>
